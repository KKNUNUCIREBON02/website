...
<html>
    <head>
        <style>
        .city {
            background-color: rgb(99, 226, 245);
            color: black;
...
<body>
    <header>
        <img align="right" src="assets/Logo2.png" alt="logo" width="300">
        <img align="left" src="assets/Logo1.png" alt="logo" width="300">
        <h1 id="myHeader">KKN UNIVERSITAS NAHDLATUL ULAMA CIREBON </br>with</br>SMPN 1 LEMAH ABANG </h1>
    </header>
    <div>
    <img align="center" src="assets/SMP1.jpg" width="1250">
    </div>
    <div class="city">
        <h2>   بسم الله الرحمن الرحيم</h2></br>
    </br><h2>Etika Berinternet dan Media Sosial</h2></br>
    </br><h3>Pendahuluan</h3>
        <p>
            Dalam era digital saat ini, internet dan media sosial telah menjadi bagian penting dari kehidupan sehari-hari, terutama bagi para remaja. Namun, seperti dalam dunia nyata, ada aturan dan etika yang harus diikuti untuk memastikan bahwa pengalaman online tetap positif dan aman. Etika berinternet adalah panduan perilaku yang bertujuan untuk menjaga keharmonisan, kenyamanan, dan keamanan semua pengguna internet.</br>
        </br>                
            1. Pengertian Etika Berinternet</br>
        </br>Etika berinternet adalah seperangkat norma dan aturan yang mengatur perilaku kita saat berinteraksi di dunia maya. Ini mencakup bagaimana kita berkomunikasi, berbagi informasi, serta berinteraksi dengan orang lain secara online.</br>
            Etika berinternet adalah seperangkat prinsip, norma, dan aturan yang mengatur perilaku seseorang saat berinteraksi di dunia maya. Etika ini mencakup bagaimana seseorang berkomunikasi, berbagi informasi, dan berinteraksi dengan orang lain secara online dengan cara yang sopan, bertanggung jawab, dan menghormati hak serta privasi orang lain.</br>
        </br>
...
<footer class="myHeader">
      <p align="center">Copyright &copy; 2024 Siti jubaedah</p>
  </footer>
</html>
